# ============================================================
#  panels/panel_konekta.py  —  Konekta Panel (CR API)
...
PANEL_NAME    = "Konekta"
PANEL_COMMAND = "konekta"     # Admin command: /panelkonekta on|off
...
API_BASE_URL = "http://51.77.216.195/crapi/konek/viewstats"
API_TOKEN    = "Qk9URjRSQoF8iYaCZY-FiFJogHx4lWKDVnOMXYdmZEd0YZFzYVOB"
API_RECORDS  = 200
    ...
    for attempt in range(1, 4):
        try:
            ...
            if payload.get("status") == "success":
                ...
                # "No Records Found" — normal hai, empty return karo
                return []
...
# ============================================================
#  SECTION 4: parse_row()
#  Gaza panel jaisa hi format hai isliye same fields
# ============================================================
